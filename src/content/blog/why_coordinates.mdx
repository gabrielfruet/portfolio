...
import optimizationGif from '../../assets/images/experiments/object_detection/l1_vs_ciou_aspect_ratio.gif';
...
<Figure src={optimizationGif} caption="Figure 5: Bounding Box Optimization" className="w-1/2 mx-auto" />